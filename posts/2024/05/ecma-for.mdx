...
thumbnail: /posts/2024/05/ecmaFor/thumbnail.png
---
...
![NewDeclarativeEnvironment는 새로운 실행 컨텍스트를 생성한다.](/posts/2024/05/ecmaFor/image_1.png)
...
![ECMAScript에서 정의하는 실행문의 작동 순서](/posts/2024/05/ecmaFor/image_2.png)
...
![CPIE의 작동 순서, 여기에 답이 있다.](/posts/2024/05/ecmaFor/image_3.png)
